       ...
       <img class="img-responsive" src="images/home_banner.jpg" style="width:100%; height:180px;">      
        ...
        <div class="row" style="color: #ed9e21">
            <div class="col-md-12 well" >
              ...
              <p style="font-size:16px;">Whether you’re travelling for business or pleasure, NestHotel makes it a simple and delightful experience to book hotels, flights and activities all in just a few clicks. Our curated and verified list of many hotels from around the globe ensures our travellers have enough options to choose from and complete their online hotel booking at ease.</p>
              <br>
              <p style="font-size:16px;">Prior to the Internet, travelers could write, telephone the hotel directly, or use a travel agent to make a reservation. Nowadays, online travel agents have pictures of hotels and rooms, information on prices and deals, and even information on local resorts. Many also allow reviews of the traveler to be recorded with the online travel agent.</p>
              <br>
              <p style="font-size:16px;">Online hotel reservations are also helpful for making last minute travel arrangements. Hotels may drop the price of a room if some rooms are still available. There are several websites that specialize in searches for deals on rooms.</p>
              
            </div>  
        </div>
        <div class="row" style="color: #ffbb2b">
            <div class="col-md-4 wellfix">
              <h4><strong  style = "color: #21ede3">Contact Us</strong></h4><hr>
              Address : E-Block, VIT Men's Hostel<br>
              Mail : deepakmalpani0@gmail.com <br>
            </div>
            <div class="col-md-4"></div>
            <div class="col-md-4 wellfix">
                <h4><strong style="color: #21ede3">Developed By</strong></h4><hr>
                <a href="https//github.com/debabiswapanda" style="color: #ffbb2b"> Machine Learning ,AI enthusiastic and IOS Application Developers</a>
            </div>
        </div>
    </div>
